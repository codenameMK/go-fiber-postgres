...
func (s *APIServer) Run() {
	...
	router.HandleFunc("/deleteAccounts" , makeHTTPHandleFunc(s.handleClearAccount))
...
func (s *APIServer)handleAccount(w http.ResponseWriter , r *http.Request) error{
	...
	if r.Method == "DELETE"{
		s.handleClearAccount(w,r)
	}
	
	return nil
}

func (s *APIServer)handleClearAccount(w http.ResponseWriter , r *http.Request)error{
	err := s.store.ClearAccounts()
	if err != nil {
		return err
	}
	return nil
...
func (s *APIServer)handleCreateAccount(w http.ResponseWriter , r *http.Request) error{
	...
	fmt.Println("JWT tocken" , tokenString)
	return WriteJSON(w , http.StatusOK , account)
}
